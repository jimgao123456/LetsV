...
/**
 * Created by gangchang on 2018/6/15.
 */
...
//                }
    ...
    private void onRecord(boolean start) {
        ...
        if (start) {
            ...
            //set audiofile storepath
            intent.putExtra("filename",getString(R.string.audio_default_file_name)+ "_" + (System.currentTimeMillis()) + ".mp4");
            //start Chronometer
